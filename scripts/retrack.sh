...
# TODO how to make these terminate appropriately. set something required in both?
# TODO probably need to start in background
ROS_HOME=$INPUT_PATH "roslaunch" multi_tracker play_delta_video.launch rate:=2.0 pause:=False delay:=5 &
cd $OUTPUT_PATH
