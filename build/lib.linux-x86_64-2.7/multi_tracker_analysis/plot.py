...
# changed from 'position_[x|y]'
def get_heatmap(pd, binsx, binsy, position_x='measurement_x', position_y='measurement_y', position_z='measurement_z', position_z_slice=None):
